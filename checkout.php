...
?>
	...
	<form method="post" action="purchase.php" class="form-horizontal">
		<?php if(isset($_SESSION['err']) && $_SESSION['err'] == 1){ ?>
			<p class="text-danger">Todos los espacios deben ser llenados</p>
			<?php } ?>
		...
		<div class="form-group">
			<label for="address" class="control-label col-md-4">Direccion</label>
			<div class="col-md-4">
		...
		<div class="form-group">
			<label for="country" class="control-label col-md-4">Pais</label>
			<div class="col-md-4">
